...
// iOS apple-touch-icon. Hand-drawn SVG paw — no emoji font dependency,
// crisp at any size. Fills the canvas (iOS adds its own corner mask).
...
function PawSVG({ size, color }: { size: number; color: string }) {
  // Centered paw print: four toe pads + a larger heart-shaped palm.
  return (
    <svg
      width={size}
      height={size}
